...
func CreateAccountHandler(w http.ResponseWriter, r *http.Request) {
	...
	// --------------------------------------------------------
	// organizations.org_id is BIGINT and is generated
	...
	// --------------------------------------------------------
	//
	// users.id is an INTEGER/BIGINT generated by PostgreSQL.
	//
	// request.UID is a separate application-level identifier
	// and is stored in the uid column.
	//
	// organizationID is BIGINT and is stored in
